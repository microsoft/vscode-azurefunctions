...
suite.only('Durable Task Scheduler (DTS) Scenarios', function (this: Mocha.Suite): void {
    ...
    suiteSetup(async function (this: Mocha.Context): Promise<void> {
        ...
        const workspaceFolderUri: Uri = getWorkspaceFolderUri('scenario-durable-dts');
    ...
    test('Create function should bring down template files and make the necessary workspace configurations', async () => {
        console.log("hello");
    });
});
