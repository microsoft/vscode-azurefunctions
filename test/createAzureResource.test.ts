...
import { DialogResponses, IActionContext, IAzureNode, IAzureParentNode, IAzureTreeItem, TestAzureTreeDataProvider, TestUserInput } from 'vscode-azureextensionui';
...
suite('Create Azure Resources', async function (this: ISuiteCallbackContext): Promise<void> {
    ...
    let testTree: TestAzureTreeDataProvider;
