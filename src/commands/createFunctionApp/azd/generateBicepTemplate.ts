...
/**
 * Generates a subscription-scoped Bicep template, a resource-group-scoped
 * resources module, and a parameters file from the wizard context.
 *
 * Template structure:
 * - `main.bicep` — subscription scope: creates the resource group, then
 *   deploys `resources.bicep` as a module into that RG.
 * - `resources.bicep` — resource-group scope: all actual resources so each
 *   appears as a separate progress line during `azd provision`.
 *
 * Resources provisioned:
 * - Resource Group (in main.bicep)
 * - Storage Account
...
export function generateBicepTemplate(context: IFlexFunctionAppWizardContext): BicepGenerationResult {
    ...
    // ── main.bicep — subscription-scoped: creates the RG, then deploys resources module ──
    const mainBicepContent = `// Auto-generated Bicep template for Azure Function App provisioning
// Generated by Azure Functions VS Code extension
// Subscription-scoped: creates the resource group and deploys all
// resources via the resources.bicep module.
...
`;
    ...
    // ── resources.bicep — resource-group-scoped: all actual resources ──
    const resourcesBicepContent = `// Auto-generated Bicep module for Azure Function App resources
// Generated by Azure Functions VS Code extension
// Resource-group-scoped: deployed by main.bicep into the created RG.
...
`;
    ...
    return { mainBicepContent, resourcesBicepContent, parametersContent };
}
