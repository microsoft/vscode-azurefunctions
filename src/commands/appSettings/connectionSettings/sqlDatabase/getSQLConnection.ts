 ...
 */
export async function getSQLConnectionIfNeeded(context: SqlConnectionContext, appSettings: StringDictionary, site: ParsedSite, projectPath: string): Promise<ISqlDbConnectionSetSettingsContext | undefined> {
