...
import { type AccessKeys, type AuthorizationRule, type EHNamespace, type EventHubManagementClient } from "@azure/arm-eventhub";
...
export async function getEventHubsNamespaceConnectionString(context: INetheriteAzureConnectionWizardContext, namespace: EHNamespace, authRule: AuthorizationRule): Promise<string> {
    ...
    return accessKeys.primaryConnectionString || accessKeys.secondaryConnectionString || '';
}
