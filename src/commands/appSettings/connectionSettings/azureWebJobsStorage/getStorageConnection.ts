...
import { type IStorageConnectionSetSettingsContext } from "../ISetConnectionSettingContext";

type StorageConnectionContext = IFuncDeployContext & ISubscriptionActionContext;

export async function getStorageConnectionIfNeeded(_context: StorageConnectionContext, _appSettings: StringDictionary, _site: ParsedSite, _projectPath: string): Promise<IStorageConnectionSetSettingsContext | undefined> {
