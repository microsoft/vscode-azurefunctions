...
async function deploy(actionContext: IActionContext, arg1: vscode.Uri | string | SlotTreeItem | undefined, arg2: string | {} | undefined, _expectedContextValue?: string | RegExp): Promise<void> {
    ...
    if (node.contextValue.includes('container')) {
        ...
        await context.ui.showWarningMessage(localize('containerFunctionAppError', 'Deploy is not currently gitgsupported for containerized function apps within the Azure Functions extension. Please read here to learn how to deploy your project'), { learnMoreLink });
