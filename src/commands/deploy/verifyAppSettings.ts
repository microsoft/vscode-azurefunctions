...
import { azureWebJobsFeatureFlags, extensionVersionKey, runFromPackageKey, StorageType, workerRuntimeKey, type ProjectLanguage } from '../../constants';
...
export async function verifyAppSettings(options: {
    ...
    durableStorageType: StorageType | undefined,
...
export async function verifyAndUpdateAppConnectionStrings(context: IActionContext & Partial<ISetConnectionSettingContext>, durableStorageType: StorageType | undefined, remoteProperties: { [propertyName: string]: string }): Promise<boolean> {
