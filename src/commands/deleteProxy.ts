...
export async function deleteProxy(context: ITreeItemActionContext, arg1?: AzExtTreeItem): Promise<void> {
    ...
    const node: ProxyTreeItem = await ext.tree.showTreeItemWizard({ id: ProxyTreeItem.contextValueId, isReadOnly: 'false' }, context, arg1);
