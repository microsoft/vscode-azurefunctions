...
export class ResolvedContainerizedFunctionAppResource implements ResolvedAppResourceBase {
    ...
    private imageTreeItem: ImageTreeItem;
    private appSettingsTreeItem: AppSettingsTreeItem;
    ...
    private get _state(): string | undefined {
        ...
        return this.site.state ? this.site.state : undefined;
    }
    ...
    public async loadMoreChildrenImpl(_clearCache: boolean): Promise<AzExtTreeItem[]> {
        ...
        this.functionsTreeItem = new FunctionsTreeItem(proxyTree, this.site);
        this.imageTreeItem = new ImageTreeItem(proxyTree, this.site, this.maskedValuesToAdd);
        ...
        const children: AzExtTreeItem[] = [this.functionsTreeItem, this.imageTreeItem, this.appSettingsTreeItem]
